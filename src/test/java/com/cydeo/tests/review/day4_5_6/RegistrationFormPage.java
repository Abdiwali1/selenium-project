...
//        selectDepartment.selectByValue("DE");
        ...
        String actualEngineeringOption = selectDepartment.getFirstSelectedOption().getText();
        String expectedEngineeringOption = "Department of Engineering";

        Assert.assertEquals(actualEngineeringOption,expectedEngineeringOption);
